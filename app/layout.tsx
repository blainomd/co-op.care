...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${manrope.variable} ${inter.variable} ${newsreader.variable} h-full antialiased`}>
      <head>
      ...
      <body className="min-h-full flex flex-col font-[var(--font-inter)]">
        ...
        `}</Script>
        <Script src="https://harnesshealth.ai/footer.js?v=10" data-brand="co-op.care" data-theme="light" strategy="lazyOnload" />
      </body>
    </html>
  );
}
